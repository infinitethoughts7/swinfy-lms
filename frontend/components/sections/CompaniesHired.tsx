...
const CompaniesHired = () => {
  const companyLogos = [
    { name: "Google", logo: "/assets/client/google.svg" },
    { name: "Microsoft", logo: "/assets/client/microsoft.svg" },
    { name: "Netflix", logo: "/assets/client/netflix.svg" },
    { name: "LinkedIn", logo: "/assets/client/linkedin.svg" },
    { name: "Mastercard", logo: "/assets/client/mastercard.svg" },
    { name: "Visa", logo: "/assets/client/visa.svg" },
    { name: "Yamaha", logo: "/assets/client/yamaha.svg" },
    { name: "Coca-Cola", logo: "/assets/client/coca-cola.svg" },
    { name: "Envato", logo: "/assets/client/envato.svg" },
    { name: "Adobe After Effects", logo: "/assets/client/aftereffect.svg" },
    { name: "Adobe Card", logo: "/assets/client/ae-card.svg" },
    { name: "Graduated", logo: "/assets/client/graduated.svg" }
  ];
