              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-sora font-bold text-text-primary">{course.level_display}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-sora font-bold text-text-primary">{course.duration_weeks} weeks</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-6 border border-purple-200">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      <h3 className="text-sm font-inter text-gray-600 uppercase tracking-wide">Category</h3>
                      <p className="text-xl font-sora font-bold text-text-primary">{course.category_display}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6 border border-orange-200">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      <h3 className="text-sm font-inter text-gray-600 uppercase tracking-wide">Price</h3>
                      <p className="text-xl font-sora font-bold text-text-primary">₹{parseFloat(course.price).toLocaleString()}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-200">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-sora font-bold text-text-primary">{course.enrollment_count.toLocaleString()}</p>
                    </div>
                  </div>
                </div>
