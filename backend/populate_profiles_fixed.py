    ...
    for tutor in tutors:
        ...
        profile, created = TutorProfile.objects.get_or_create(
            ...
            defaults={
                ...
                'phone_number': tutor_data.get(tutor.email, {}).get('phone_number', '+91-9876543226'),
...
def populate_admin_profiles():
    ...
    admin_data = {
        ...
        'sita.rama.lakshmi@outlook.com': {
            ...
            'office_phone': '+91-80-28520261',
            'emergency_contact': '+91-9876543233',
        ...
        'ravi.teja.reddy@hotmail.com': {
            ...
            'office_phone': '+91-11-26597135',
            'emergency_contact': '+91-9876543235',
        ...
        'lakshmi.priya.devi@yahoo.com': {
            ...
            'office_phone': '+91-80-22932000',
            'emergency_contact': '+91-9876543237',
        ...
        'venkata.sai.krishna@gmail.com': {
            ...
            'office_phone': '+91-80-40404040',
            'emergency_contact': '+91-9876543239',
    ...
    for admin in admins:
        ...
        profile, created = AdminProfile.objects.get_or_create(
            ...
            defaults={
                ...
                'phone_number': admin_data.get(admin.email, {}).get('phone_number', '+91-9876543240'),
                ...
                'office_phone': admin_data.get(admin.email, {}).get('office_phone', '+91-9876543241'),
                'emergency_contact': admin_data.get(admin.email, {}).get('emergency_contact', '+91-9876543242'),
